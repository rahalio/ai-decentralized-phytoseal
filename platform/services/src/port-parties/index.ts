/**
 * PortParties Services - Application Layer Export
 *
...
/**
 * PortParties Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for port-parties domain.
 */
