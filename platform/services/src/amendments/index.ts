/**
 * Amendments Services - Application Layer Export
 *
...
/**
 * Amendments Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for amendments domain.
 */
